			    ...
			    <div className="row">
			      <div className="col-lg-6 align-self-center">
			        <div className="about-us-info-wrap">
			          <div className="section-title-area ltn__section-title-2--- mb-30">
			            ...
			            <h1 className="section-title">For Sale: 3-Bedroom Luxury Villa</h1>
			            <p>Located in the heart of Luviana, this exquisite villa is perfect for those seeking comfort and style. Enjoy the convenience of nearby amenities and a vibrant lifestyle with live music concerts and island boat tours just steps away.</p>
			          </div>
			      ...
			      <div className="col-lg-6 align-self-center">
			        <div className="about-us-img-wrap about-img-right">
			          <img src={publicUrl+"assets/img/others/9.webp"} alt="About Us Image" />
			        </div>
			      </div>
			    </div>
			  </div>
