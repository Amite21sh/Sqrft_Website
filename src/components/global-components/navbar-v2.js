				...
				<div className="ltn__header-top-area d-none">
					...
					<div className="row">
						...
						<div className="ltn__top-bar-menu">
							<ul>
							<li><a href="mailto:info@sqrftinfratech.com?Subject=Flower%20greetings%20to%20you"><i className="icon-mail" /> info@sqrftinfratech.com</a></li>
							<li><a href="locations.html"><i className="icon-placeholder" /> D-215, D Block, Sector 63, Noida, Uttar Pradesh 201301</a></li>
							</ul>
						</div>
						</div>
