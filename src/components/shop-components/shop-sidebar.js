   ...
   let publicUrl = process.env.PUBLIC_URL+'/'
    return (
		<div className="col-lg-4  mb-100">
			...
			<label className="mb-30"><small></small></label>
			...
			<div className="widget ltn__menu-widget">
				...
				<li>
					<label className="checkbox-item">Residentials
					<input type="checkbox" />
					<span className="checkmark" />
					</label>
				...
				<h4 className="ltn__widget-title">BHK</h4>
				<ul>
				<li>
					...
					<span className="categorey-no">5</span>
				</li>
				<li>
					...
					<span className="categorey-no">4</span>
				</li>
				<li>
					<label className="checkbox-item">Triple
					<input type="checkbox" />
					<span className="checkmark" />
					</label>
					<span className="categorey-no">3</span>
				</li>
				<li>
					<label className="checkbox-item">Up To 4
					<input type="checkbox" />
					<span className="checkmark" />
					</label>
					<span className="categorey-no">7</span>
				</li>
				</ul>
				<hr />
			</div>
